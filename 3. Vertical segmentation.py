...
for i in range(4):
    ...
    # alphalit contains lithuanian letters
    alphalit={'à': '100001', 'è': '100100', 'æ': '100011', 'ë': '001110', 'á': '010101', 'ð': '011101', 'ø': '001101', 'û': '110011', 'þ': '110001'}
    ...
    for ch,valu in alphalit.iteritems():
            if cvt[0]==valu:
                    f.write (ch)
                    continue
